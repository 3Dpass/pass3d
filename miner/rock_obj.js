...
class RockObj {
    ...
    varyMesh() {
        this.varyParameter(this.meshNoiseScale, MESH_NOISE_SCALE_VARY, MESH_NOISE_SCALE_MIN, MESH_NOISE_SCALE_MAX);
        this.varyParameter(this.meshNoiseStrength, MESH_NOISE_STRENGTH_VARY, MESH_NOISE_STRENGTH_MIN, MESH_NOISE_STRENGTH_MAX);
